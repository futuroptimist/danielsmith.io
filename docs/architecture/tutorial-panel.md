...
- Renders progress/status groups as block-level content with vertical spacing from body
  copy and from the navigation row so wrapped localized text cannot collide with badges.
