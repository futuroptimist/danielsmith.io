...
| Linting & types          | Source TypeScript            | `npm run lint`, `npm run typecheck` | Linting runs ESLint; `npm run check` includes lint, typecheck, tests, docs validation, and smoke.                  |
