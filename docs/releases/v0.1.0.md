...
cAdvisor resource metrics, and Kubernetes release metadata where available. See the
[static-site observability contract](../ops/observability.md) for the monitoring
boundary and promotion-smoke evidence workflow; this launch checklist does not claim live
