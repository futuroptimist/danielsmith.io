...
See [the static-site observability contract](../ops/observability.md) for the monitoring
boundaries, paging-critical paths, non-paging release checks, and promotion smoke commands. This
link documents the intended contract and does not claim live monitoring has already been deployed.
