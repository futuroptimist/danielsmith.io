...
- ✅ Subtitle/captions system for ambient audio callouts and POI captions.
  ...
  - ✅ Audio subtitles overlay now surfaces ambient beds and POI captions with cooldown-aware captions.
  - ✅ Subtitle queue now sequences overlapping ambient and POI caption clips so lower-priority
    callouts surface once higher-priority events finish.
  - ✅ High-priority POI captions now temporarily escalate the subtitles live region to
...
- ✅ Ambient caption bridge now honors per-bed priorities so critical POI captions can override
