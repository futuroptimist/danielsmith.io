...
- ✅ Subtitle/captions system for ambient audio callouts.
  ...
  - ✅ Audio subtitles overlay now surfaces ambient beds with cooldown-aware captions.
  - ✅ Subtitle queue now sequences overlapping ambient clips so lower-priority
    callouts surface once higher-priority events finish.
  - ✅ High-priority captions now temporarily escalate the subtitles live region to
