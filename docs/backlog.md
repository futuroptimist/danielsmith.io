...
- perf: Immersive launch diagnostics now enforce draw-call, triangle, geometry,
  texture/proxy, and non-software p95 frame-time budgets via `npm run perf:budget`.
