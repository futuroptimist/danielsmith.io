...
\usepackage{enumitem}
\usepackage{titlesec}
\setlist[itemize]{leftmargin=*, label={--}, itemsep=0.15mm, topsep=0.15mm,
  parsep=0pt, partopsep=0pt}
\titlespacing*{\section}{0pt}{1.6mm}{0.7mm}
...
and accessible full-stack products, with strengths in release engineering, operational
...
BigQuery/GoogleSQL \\
\textbf{Platform \& Delivery:} Kubernetes, k3s, Helm, Docker/OCI, Linux, GitHub Actions,
GHCR, Cloudflare, Google Cloud \\
...
\textit{GPA: 4.0} \hfill Aug 2011 -- May 2013
