  ...
  hud: {
    ...
    tutorialPanel: {
      ...
      actions: {
        ...
        zoomPrompt: 'Reach both zoom limits.',
        zoomInLabel: 'In',
        zoomOutLabel: 'Out',
        zoomChipAriaTemplate: 'Zoom {direction}: {status}',
        poiCounterTemplate: '{count}/{goal} POIs visited',
        poiCounterAriaTemplate:
          '{count} of {goal} project exhibits visited: {status}',
        gitshelvesObjective: 'Gitshelves visited',
        gitshelvesHint: 'Hint: check upstairs.',
        gitshelvesAriaTemplate: 'Gitshelves objective: {status}',
      },
      completedStepLabel: 'Completed',
      pages: {
        welcomeMovement: {
          title: 'Welcome',
          body: 'Welcome to Daniel Smith’s interactive portfolio. This space showcases projects as exhibits you can explore. Move in all four cardinal directions with W, A, S, and D; arrow keys and the touch joystick count too. If immersive mode is not your preference, switch to the text-only version.',
        },
        zoom: {
          title: 'Zoom',
          body: 'Zoom all the way in and all the way out. Use the mouse scroll wheel, a multitouch pinch, or keyboard Shift + = and Shift + -.',
        },
        visitPois: {
          title: 'Visit POIs',
          body: 'POIs are project exhibits. Their panels share summaries, outcomes, metrics, links, and context. Click, tap, or interact with a POI to mark it visited.',
        },
        findGitshelves: {
