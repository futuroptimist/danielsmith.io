  ...
  hud: {
    ...
    tutorialPanel: {
      ...
      actions: {
        ...
        zoomPrompt: 'صل إلى حدي التكبير.',
        zoomInLabel: 'تكبير',
        zoomOutLabel: 'تصغير',
        zoomChipAriaTemplate: 'التكبير {direction}: {status}',
        poiCounterTemplate: 'تمت زيارة {count}/{goal} من نقاط الاهتمام',
        poiCounterAriaTemplate:
          'تمت زيارة {count} من {goal} معارض مشاريع: {status}',
        gitshelvesObjective: 'تمت زيارة Gitshelves',
        gitshelvesHint: 'تلميح: تحقق في الطابق العلوي.',
        gitshelvesAriaTemplate: 'هدف Gitshelves: {status}',
      },
      completedStepLabel: 'مكتمل',
      pages: {
        welcomeMovement: {
          title: 'مرحبًا',
          body: 'مرحبًا بك في محفظة دانيال سميث التفاعلية. يعرض هذا المكان المشاريع كمعروضات يمكنك استكشافها. تحرّك في الاتجاهات الأربعة باستخدام W و A و S و D؛ كما تُحتسب مفاتيح الأسهم وعصا اللمس. إذا لم تفضّل الوضع الغامر، فانتقل إلى النسخة النصية فقط.',
        },
        zoom: {
          title: 'التكبير',
          body: 'كبّر إلى أقصى حد وصغّر إلى أقصى حد. استخدم عجلة تمرير الفأرة، أو قرصة اللمس المتعدد، أو لوحة المفاتيح Shift + = و Shift + -.',
        },
        visitPois: {
          title: 'زيارة نقاط الاهتمام',
          body: 'نقاط الاهتمام هي معروضات مشاريع. تعرض لوحاتها ملخصات ونتائج ومقاييس وروابط وسياقًا. انقر أو المس أو تفاعل مع نقطة اهتمام لتمييزها كزيارة.',
        },
        findGitshelves: {
