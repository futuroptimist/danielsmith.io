  ...
  hud: {
    ...
    tutorialPanel: {
      ...
      actions: {
        ...
        zoomPrompt: '両方のズーム端に到達します。',
        zoomInLabel: 'イン',
        zoomOutLabel: 'アウト',
        zoomChipAriaTemplate: 'ズーム{direction}: {status}',
        poiCounterTemplate: '{count}/{goal} POI訪問済み',
        poiCounterAriaTemplate: '{goal}件中{count}件の展示を訪問済み: {status}',
        gitshelvesObjective: 'Gitshelvesを訪問済み',
        gitshelvesHint: 'ヒント: 2階を確認してください。',
        gitshelvesAriaTemplate: 'Gitshelves目標: {status}',
      },
      completedStepLabel: '完了',
      pages: {
        welcomeMovement: {
          title: 'ようこそ',
          body: 'Daniel Smith のインタラクティブなポートフォリオへようこそ。ここではプロジェクトを探索できる展示として紹介します。W、A、S、D の4方向へ移動してください。矢印キーとタッチジョイスティックもカウントされます。没入モードを使わない場合は、テキスト専用版に切り替えられます。',
        },
        zoom: {
          title: 'ズーム',
          body: '最後までズームインし、最後までズームアウトしてください。マウスホイール、マルチタッチのピンチ、または Shift + = と Shift + - を使えます。',
        },
        visitPois: {
          title: 'POI を訪問',
        ...
        findGitshelves: {
          ...
          body: 'Gitshelves POI を見つけて操作してください。ヒント: 2階を確認してください。',
        },
      },
    },
    helpModal: {
