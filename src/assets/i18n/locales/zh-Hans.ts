  ...
  hud: {
    ...
    tutorialPanel: {
      ...
      actions: {
        ...
        zoomInLabel: '放大',
        zoomOutLabel: '缩小',
        zoomChipAriaTemplate: '缩放{direction}：{status}',
        poiCounterTemplate: '已访问 {count}/{goal} 个 POI',
        poiCounterAriaTemplate:
          '已访问 {goal} 个项目展品中的 {count} 个：{status}',
        gitshelvesObjective: '已访问 Gitshelves',
        gitshelvesHint: '提示：去楼上看看。',
        gitshelvesAriaTemplate: 'Gitshelves 目标：{status}',
      },
      completedStepLabel: '已完成',
      pages: {
        welcomeMovement: {
          title: '欢迎',
          body: '欢迎来到 Daniel Smith 的互动作品集。这里把项目展示成可探索的展品。请用 W、A、S、D 向四个方向移动；方向键和触控摇杆也会计入。如果你不想使用沉浸模式，可以切换到纯文本版本。',
        },
        zoom: {
          title: '缩放',
          body: '请一直放大到最大，再一直缩小到最小。可使用鼠标滚轮、多点触控捏合，或键盘 Shift + = 和 Shift + -。',
        },
        visitPois: {
          title: '访问 POI',
          body: 'POI 是项目展品。POI 面板会显示摘要、成果、指标、链接和背景。点击、轻点或与 POI 互动即可标记为已访问。',
        },
        findGitshelves: {
          title: '找到 Gitshelves',
          body: '找到并与 Gitshelves POI 互动。提示：去楼上看看。',
        },
      },
    },
    helpModal: {
