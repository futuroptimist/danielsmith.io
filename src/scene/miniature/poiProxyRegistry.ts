...
export const MINIATURE_POI_PROXY_REGISTRY = {
  ...
  'pr-reaper-backyard-console': {
    ...
    syncRevision: 4,
    syncNote:
      'Static hologram/projector/robot silhouette tracks the finalized P5b geometry and bounds contract.',
    sourceFiles: [
      ...baseFiles,
    ...
    primitives: [
      ...
      box(
        'reaper-hologram-screen-silhouette',
        [0.54, 1.26, 0.025],
        [0, 0.75, 0],
        0x38bdf8
      ),
      sphere('reaper-red-circle-hint-0', 0.055, [-0.14, 1.05, 0.03], 0xef4444),
      sphere('reaper-red-circle-hint-1', 0.055, [0.12, 0.82, 0.03], 0xef4444),
      sphere('reaper-red-circle-hint-2', 0.055, [-0.04, 0.56, 0.03], 0xef4444),
      sphere('reaper-green-circle-hint', 0.055, [0.16, 1.2, 0.03], 0x22c55e),
      cyl('reaper-yaw-arm-base', 0.14, 0.18, [0, 0.09, 0.78], 0x334155),
      cyl('reaper-pitch-shoulder', 0.1, 0.16, [0, 0.35, 0.78], 0x475569),
      box(
        'reaper-pitched-arm-link',
        [0.12, 0.1, 0.42],
        [0, 0.43, 0.58],
        0x64748b
      ),
