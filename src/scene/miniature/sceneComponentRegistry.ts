...
export const MINIATURE_SCENE_COMPONENT_COVERAGE = [
  {
    ...
    syncRevision: 3,
    syncNote:
      'Upper landing floor seam split keeps tabletop layout proxy coverage unchanged.',
  },
  {
  ...
  },
  {
    ...
    syncRevision: 35,
    syncNote:
      'Studio rug footprint separation is source-only; tabletop furnishing proxy coverage is unchanged.',
    reason:
