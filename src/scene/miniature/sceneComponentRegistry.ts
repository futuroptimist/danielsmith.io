...
export const MINIATURE_SCENE_COMPONENT_COVERAGE = [
  ...
  },
  {
    ...
    syncRevision: 3,
    reason:
      'POI recommendation tooltip code was simplified after recommendation cleanup; markers and labels remain interaction UI, not miniature geometry.',
  },
  {
  ...
  },
  {
    ...
    syncRevision: 2,
    reason:
      'Accessory manager now tracks checkbox state only; preset bundle APIs were removed without changing miniature geometry.',
  },
  {
  ...
  },
  {
    ...
    syncRevision: 2,
    reason:
      'POI overlay recommendation code was simplified after recommendation cleanup; this DOM overlay remains non-miniature UI.',
  },
  {
