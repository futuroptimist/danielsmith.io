...
export const DEFAULT_UPPER_FLOOR_FURNISHINGS: readonly UpperFloorFurnishingDefinition[] =
  [
    ...
    },
    {
      ...
      kind: 'gallery-plinth',
      visual: { color: 0xd6c3a3, accentColor: 0x46536a, height: 0.95 },
    },
    {
      id: 'upper-landing-gallery-wall',
      category: 'plants-lighting-decor',
      roomId: 'upperLanding',
      position: { x: 13.8, y: 1.45, z: -31.85 },
      orientationRadians: 0,
      kind: 'wall-art-triptych-detail',
      visual: { color: 0xd6c3a3, accentColor: 0x384c5c, height: 0.62 },
    },
    {
      id: 'upper-landing-small-vase',
      category: 'plants-lighting-decor',
      roomId: 'upperLanding',
      position: { x: 15.8, y: 1.02, z: -30.4 },
      orientationRadians: 0,
      kind: 'table-vase-detail',
      visual: { color: 0xc4955a, accentColor: 0xf1e9da, height: 0.28 },
    },
    {
...

    {
      ...
      solidFootprint: { width: 0.8, depth: 0.8 },
      kind: 'fern-plant',
      visual: { color: 0x8a5a36, accentColor: 0x5f9f63, height: 0.95 },
    },
    {
    ...
    },
    {
      ...
      visual: { color: 0x56616f, accentColor: 0xc29249, height: 0.9 },
    },
    {
      id: 'creators-studio-hanging-plant-west',
      category: 'plants-lighting-decor',
      roomId: 'creatorsStudio',
      position: { x: -19.6, y: 1.7, z: -23.8 },
    ...
    },
    {
      ...
      category: 'creators-studio',
      roomId: 'creatorsStudio',
      position: { x: -9.4, y: 1.35, z: -31.85 },
      orientationRadians: 0,
      kind: 'wall-pinboard-detail',
      visual: { color: 0x8b6f47, accentColor: 0xd8ccb8, height: 0.68 },
    },
    {
      ...
      visual: { color: 0x42546a, accentColor: 0xd6c3a3, height: 0.18 },
    },
    {
    ...
    },
    {
      ...
      category: 'loft-library',
      roomId: 'loftLibrary',
      position: { x: 8.2, y: 0.62, z: -9.0 },
      orientationRadians: 0,
      kind: 'table-books-detail',
      visual: { color: 0x42546a, accentColor: 0xc29249, height: 0.18 },
    },
    {
      id: 'loft-library-wall-art',
      category: 'loft-library',
      roomId: 'loftLibrary',
      position: { x: 14.0, y: 1.45, z: 11.85 },
      orientationRadians: Math.PI,
      kind: 'wall-art-panel-detail',
      visual: { color: 0xd6c3a3, accentColor: 0x42546a, height: 0.7 },
    },
    {
      id: 'loft-library-hanging-vine',
      category: 'plants-lighting-decor',
      roomId: 'loftLibrary',
      position: { x: 23.6, y: 1.8, z: 4.8 },
      orientationRadians: Math.PI / 2,
      kind: 'hanging-plant-detail',
      visual: { color: 0x7a5134, accentColor: 0x5f9f63, height: 0.9 },
    },
    {
    ...
    },
    {
      ...
      visual: { color: 0x8a5a36, accentColor: 0x6e9b58, height: 0.62 },
    },
    {
      ...
      solidFootprint: { width: 0.55, depth: 0.55 },
      kind: 'floor-lamp',
      visual: { color: 0x2b2b2f, accentColor: 0xffd48a, height: 1.4 },
    },
    {
      id: 'focus-pods-cushion-scatter',
      category: 'focus-pods',
      roomId: 'focusPods',
      position: { x: 19.6, y: 0.75, z: 25.2 },
      orientationRadians: 0,
      kind: 'cushion-scatter-detail',
      visual: { color: 0xd8c7a7, accentColor: 0x7d6f89, height: 0.22 },
    },
    {
      id: 'focus-pods-wall-planters',
      category: 'plants-lighting-decor',
      roomId: 'focusPods',
      position: { x: -10.0, y: 1.35, z: 27.85 },
      orientationRadians: Math.PI,
      kind: 'wall-planters-detail',
      visual: { color: 0x7a5134, accentColor: 0x5f9f63, height: 0.52 },
    },
    {
      id: 'focus-pods-soft-light-strip',
      category: 'focus-pods',
      roomId: 'focusPods',
      position: { x: 5.0, y: 1.95, z: 27.85 },
      orientationRadians: Math.PI,
      kind: 'soft-light-strip-detail',
      visual: { color: 0x2f3740, accentColor: 0xffd48a, height: 0.18 },
    },
    {
