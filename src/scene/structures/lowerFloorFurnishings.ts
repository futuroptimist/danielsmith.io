  ...
  [
    {
      ...
      solidBounds: { minX: 4.7, maxX: 7.7, minZ: -30.9, maxZ: -30.1 },
      kind: 'storage-drawer-console',
      visual: { color: 0x5f6f7f, accentColor: 0xd8c7a7, height: 0.55 },
    },
    {
      ...
      solidBounds: { minX: 19.4, maxX: 20.2, minZ: -25.75, maxZ: -22.25 },
      kind: 'storage-drawer-console',
    ...
    },
    {
      ...
      solidBounds: { minX: 19.35, maxX: 20.05, minZ: -18.15, maxZ: -17.45 },
    ...
    },
    {
      ...
      category: 'upper-landing',
      roomId: 'upperLanding',
      position: { x: 7.0, z: -26.0 },
      orientationRadians: 0,
      decorativeFootprint: { width: 3.2, depth: 7.0 },
      decorativeBounds: { minX: 5.4, maxX: 8.6, minZ: -29.5, maxZ: -22.5 },
      kind: 'landing-runner-rug',
      visual: {
        color: 0x3f566b,
    ...
    },
    {
      ...
      solidBounds: { minX: -4.8, maxX: -0.8, minZ: -24.0, maxZ: -22.0 },
      kind: 'media-sofa',
    ...
    },
    {
      ...
      solidBounds: { minX: -3.9, maxX: -1.7, minZ: -20.3, maxZ: -19.3 },
      kind: 'coffee-table',
    ...
    },
    {
      ...
      solidBounds: { minX: -6.2, maxX: -2.2, minZ: -31.575, maxZ: -30.825 },
    ...
    },
    {
      ...
      solidBounds: { minX: 2.4, maxX: 3.2, minZ: -8.0, maxZ: -4.0 },
      kind: 'storage-drawer-console',
      visual: { color: 0x56616f, accentColor: 0xd8ccb8, height: 1.4 },
    },
    {
      ...
      solidBounds: { minX: 2.4, maxX: 3.2, minZ: -1.7, maxZ: -0.9 },
      kind: 'monstera-plant',
    ...
    },
    {
      ...
      decorativeBounds: { minX: -5.2, maxX: -0.4, minZ: -23.6, maxZ: -19.0 },
      kind: 'sofa-rug',
      visual: {
        color: 0x42546a,
    ...
    },
    {
      ...
      solidBounds: { minX: 5.4, maxX: 9.6, minZ: -13.0, maxZ: -11.0 },
      kind: 'media-sofa',
    ...
    },
    {
      ...
      solidBounds: { minX: 7.6, maxX: 8.8, minZ: -9.6, maxZ: -8.4 },
      kind: 'coffee-table',
      visual: { color: 0x7a5538, accentColor: 0x2f2520, height: 0.42 },
    },
    {
      ...
      solidBounds: { minX: 22.55, maxX: 23.45, minZ: -7.0, maxZ: -1.0 },
    ...
    },
    {
      ...
      solidBounds: { minX: 4.725, maxX: 5.275, minZ: -8.275, maxZ: -7.725 },
      kind: 'floor-lamp',
    ...
    },
    {
      ...
      orientationRadians: 0,
      solidFootprint: { width: 0.8, depth: 0.8 },
      solidBounds: { minX: 22.3, maxX: 23.1, minZ: 9.4, maxZ: 10.2 },
      kind: 'large-potted-plant',
      visual: { color: 0x8a5a36, accentColor: 0x5f8f48, height: 1.65 },
    },
    {
      ...
      decorativeBounds: { minX: 5.2, maxX: 10.8, minZ: -12.7, maxZ: -8.5 },
      kind: 'library-area-rug',
      visual: {
        color: 0x384c5c,
        accentColor: 0xcaa66a,
        decorativeHeight: 0.025,
    ...
    },
    {
      ...
      solidBounds: { minX: 17.8, maxX: 22.2, minZ: 24.4, maxZ: 26.2 },
    ...
    },
    {
      ...
      solidBounds: { minX: 4.85, maxX: 6.15, minZ: 23.85, maxZ: 25.15 },
      kind: 'coffee-table',
      visual: { color: 0x7a5538, accentColor: 0x2f2520, height: 0.42 },
    },
    {
      ...
      solidBounds: { minX: 1.5, maxX: 6.5, minZ: 26.8, maxZ: 27.6 },
      kind: 'storage-drawer-console',
      visual: { color: 0x4b5563, accentColor: 0xc4955a, height: 0.82 },
    },
    {
      ...
      orientationRadians: 0,
      solidFootprint: { width: 0.8, depth: 0.8 },
      solidBounds: { minX: 22.6, maxX: 23.4, minZ: 20.1, maxZ: 20.9 },
      kind: 'large-potted-plant',
      visual: { color: 0x8a5a36, accentColor: 0x5f8f48, height: 1.65 },
    },
    {
      ...
      solidBounds: { minX: -8.25, maxX: -3.75, minZ: 26.75, maxZ: 27.25 },
    ...
    },
    {
      ...
      decorativeBounds: { minX: 1.9, maxX: 8.1, minZ: 22.8, maxZ: 26.8 },
      kind: 'focus-soft-rug',
      visual: {
        color: 0x46596f,
        accentColor: 0xd6c3a3,
