...
export const DEFAULT_UPPER_FLOOR_FURNISHINGS: readonly UpperFloorFurnishingDefinition[] =
  [
    ...
    },
    {
      ...
      kind: 'gallery-plinth',
      visual: { color: 0xd8ccb8, accentColor: 0x6f7f92, height: 0.82 },
    },
    {
    ...
    },
    {
      ...
      orientationRadians: 0,
      solidFootprint: { width: 0.8, depth: 0.8 },
      kind: 'leafy-window-planter',
      visual: { color: 0x8a5a36, accentColor: 0x6e9b58, height: 0.9 },
    },
    {
    ...
    },
    {
      ...
      orientationRadians: 0,
      solidFootprint: { width: 0.9, depth: 0.9 },
      kind: 'indoor-tree-planter',
      visual: { color: 0x7a5134, accentColor: 0x4f8f4f, height: 1.8 },
    },
    {
    ...
    },
    {
      ...
      category: 'plants-lighting-decor',
      roomId: 'upperLanding',
      position: { x: 13.8, y: 1.7, z: -31.85 },
      orientationRadians: 0,
      kind: 'wall-art-gallery-detail',
      visual: { color: 0xd6c3a3, accentColor: 0x384c5c, height: 0.8 },
    },
    {
      id: 'upper-landing-small-vase',
      category: 'upper-landing',
      roomId: 'upperLanding',
      position: { x: 15.8, y: 0.96, z: -30.4 },
      orientationRadians: 0,
      kind: 'table-vase-detail',
      visual: { color: 0xc28d52, accentColor: 0xf1e9da, height: 0.28 },
    },
    {
      id: 'creators-studio-hanging-plant-west',
      category: 'plants-lighting-decor',
      roomId: 'creatorsStudio',
      position: { x: -19.7, y: 1.85, z: -12.6 },
      orientationRadians: Math.PI / 2,
      kind: 'hanging-plant-detail',
      visual: { color: 0x7a5134, accentColor: 0x5f9f63, height: 0.75 },
    },
    {
      id: 'creators-studio-pinboard',
      category: 'creators-studio',
      roomId: 'creatorsStudio',
      position: { x: -9.0, y: 1.55, z: -31.85 },
      orientationRadians: 0,
      kind: 'wall-pinboard-detail',
      visual: { color: 0x6b4a33, accentColor: 0xc29249, height: 0.7 },
    },
    {
      id: 'creators-studio-table-books',
      category: 'creators-studio',
      roomId: 'creatorsStudio',
      position: { x: -2.8, y: 0.62, z: -19.8 },
      orientationRadians: 0,
      kind: 'table-books-detail',
      visual: { color: 0x384c5c, accentColor: 0xd6c3a3, height: 0.2 },
    },
    {
      id: 'loft-library-book-stacks',
      category: 'loft-library',
      roomId: 'loftLibrary',
      position: { x: 8.2, y: 0.72, z: -9.0 },
      orientationRadians: 0,
      kind: 'table-books-detail',
      visual: { color: 0x384c5c, accentColor: 0xd6c3a3, height: 0.22 },
    },
    {
      id: 'loft-library-wall-art',
      category: 'loft-library',
      roomId: 'loftLibrary',
      position: { x: 23.85, y: 1.65, z: -9.0 },
      orientationRadians: Math.PI / 2,
      kind: 'wall-art-panel-detail',
      visual: { color: 0xd6c3a3, accentColor: 0x42546a, height: 0.75 },
    },
    {
      id: 'loft-library-hanging-vine',
      category: 'plants-lighting-decor',
      roomId: 'loftLibrary',
      position: { x: 4.3, y: 1.9, z: 6.0 },
      orientationRadians: 0,
      kind: 'hanging-vine-plant-detail',
      visual: { color: 0x7a5134, accentColor: 0x5f9f63, height: 0.85 },
    },
    {
      id: 'focus-pods-cushion-scatter',
      category: 'focus-pods',
      roomId: 'focusPods',
      position: { x: 19.5, y: 0.86, z: 25.2 },
      orientationRadians: 0,
      kind: 'cushion-scatter-detail',
      visual: { color: 0x9a6f58, accentColor: 0xd8c7a7, height: 0.22 },
    },
    {
      id: 'focus-pods-wall-planters',
      category: 'plants-lighting-decor',
      roomId: 'focusPods',
      position: { x: -19.85, y: 1.45, z: 22.5 },
      orientationRadians: Math.PI / 2,
      kind: 'wall-planters-plant-detail',
      visual: { color: 0x8a5a36, accentColor: 0x6f9f5d, height: 0.62 },
    },
    {
      id: 'focus-pods-soft-light-strip',
      category: 'focus-pods',
      roomId: 'focusPods',
      position: { x: 4.8, y: 2.2, z: 27.85 },
      orientationRadians: 0,
