...
export const DEFAULT_LOWER_FLOOR_FURNISHINGS: readonly LowerFloorFurnishingDefinition[] =
  [
...

    {
      ...
      kind: 'plant-stool',
      visual: { color: 0x6a4a32, accentColor: 0x4f9a55, height: 1.05 },
    },
    {
    ...
    },
    {
      ...
      kind: 'monstera-plant',
      visual: { color: 0x8a5a36, accentColor: 0x6e9b58, height: 1.05 },
    },
    {
      ...
      kind: 'floor-cushion',
      visual: { color: 0xb86f5f, accentColor: 0xd8c7a7, height: 0.28 },
    },
    {
      ...
      kind: 'round-pouf',
      visual: { color: 0x7d6f89, accentColor: 0xd8c7a7, height: 0.42 },
    },
    {
      ...
      visual: { color: 0x4b5563, accentColor: 0xc4955a, height: 0.78 },
    },
    {
      id: 'living-room-wall-art-south-triptych',
      category: 'plants-lighting-decor',
      roomId: 'livingRoom',
      position: { x: 14.0, z: -31.85 },
      orientationRadians: 0,
      kind: 'wall-art-triptych-detail',
      visual: { color: 0xd6c3a3, accentColor: 0x384c5c, height: 1.35 },
    },
    {
      id: 'living-room-console-plant',
      category: 'plants-lighting-decor',
      roomId: 'livingRoom',
      position: { x: -2.0, z: -31.1 },
      orientationRadians: 0,
      kind: 'console-plant-detail',
      visual: { color: 0xb7834f, accentColor: 0x6f9f5d, height: 1.0 },
    },
    {
      ...
      visual: { color: 0xcaa66a, accentColor: 0x8fd0a6, height: 0.5 },
    },
    {
    ...
    },
    {
      ...
      kind: 'kitchen-bar-stool',
      visual: { color: 0x2f3740, accentColor: 0xc28d52, height: 0.72 },
    },
    {
    ...
    },
    {
      ...
      kind: 'plant-stool',
      visual: { color: 0x6a4a32, accentColor: 0x6f9f5d, height: 0.95 },
    },
    {
    ...
    },
    {
      ...
      category: 'kitchenette',
      roomId: 'kitchen',
      position: { x: -31.2, z: 1.8 },
      orientationRadians: 0,
      kind: 'spice-rack-detail',
      visual: { color: 0x6b4a33, accentColor: 0xcaa66a, height: 1.35 },
    },
    {
...

    {
      ...
      kind: 'floor-lamp',
      visual: { color: 0xd6c3a3, accentColor: 0xffd48a, height: 1.65 },
    },
    {
      ...
      kind: 'monstera-plant',
      visual: { color: 0x7a5134, accentColor: 0x4f8f4f, height: 1.45 },
    },
    ...
    },
    {
      ...
      kind: 'storage-drawer-console',
      visual: { color: 0x56616f, accentColor: 0xd8ccb8, height: 0.56 },
    },
    {
      id: 'studio-woven-rug',
      category: 'sleeping-nook',
    ...
    },
    {
      ...
      category: 'plants-lighting-decor',
      roomId: 'studio',
      position: { x: 31.8, z: 9.2 },
      orientationRadians: 0,
      kind: 'hanging-plant-detail',
      visual: { color: 0xb7834f, accentColor: 0x6f9f5d, height: 1.75 },
    },
...

    {
      ...
      visual: { color: 0x9aa8b7, accentColor: 0x8ecae6, height: 0.95 },
    },
    {
      id: 'backyard-herb-trough-north',
      category: 'backyard',
      roomId: 'backyard',
      position: { x: -5.5, z: 30.8 },
      orientationRadians: 0,
      solidFootprint: { width: 3.0, depth: 0.6 },
      solidBounds: { minX: -7.0, maxX: -4.0, minZ: 30.5, maxZ: 31.1 },
      kind: 'backyard-herb-trough',
      visual: { color: 0x7a5134, accentColor: 0x6f9f5d, height: 0.65 },
    },
    {
      ...
      visual: { color: 0x8a5a36, accentColor: 0xd66f8d, height: 1.0 },
    },
    {
      ...
      kind: 'backyard-umbrella-base',
      visual: { color: 0x2f3740, accentColor: 0xd6c3a3, height: 2.4 },
    },
    {
    ...
    },
    {
      ...
      category: 'backyard',
      roomId: 'backyard',
      position: { x: 24.0, z: 21.0 },
      orientationRadians: 0,
      kind: 'string-lights-detail',
      visual: { color: 0x2f3740, accentColor: 0xffd48a, height: 2.55 },
    },
    {
      id: 'backyard-watering-can',
      category: 'backyard',
      roomId: 'backyard',
      position: { x: -6.6, z: 30.7 },
      orientationRadians: 0,
      kind: 'watering-can-detail',
      visual: { color: 0x6f8aa0, accentColor: 0xc9d1d6, height: 0.35 },
    },
...
function createBackyardFurnishing(
  ...
  if (definition.kind === 'backyard-birdbath') {
    addBox(
      group,
      'birdbathPedestal',
      { width: 0.24, height: 0.62, depth: 0.24 },
      primaryMaterial,
      [0, 0.31, 0]
    );
    addBox(
      group,
      'birdbathBasin',
      { width: 0.82, height: 0.16, depth: 0.82 },
      primaryMaterial,
      [0, 0.7, 0]
    );
    addBox(
  ...
  if (definition.kind === 'backyard-herb-trough') {
    addBox(
      group,
      'herbTroughBox',
      { width: footprint.width, height: 0.32, depth: footprint.depth },
      primaryMaterial,
      [0, 0.16, 0]
    );
    [-1.0, -0.5, 0, 0.5, 1.0].forEach((x, index) => {
      addBox(
        ...
        { width: 0.16, height: 0.34, depth: 0.16 },
        accentMaterial,
        [x, 0.48, 0]
      );
    });
  ...
  if (definition.kind === 'backyard-umbrella-base') {
    addBox(
      group,
      'umbrellaBase',
    ...
    addBox(
      group,
      'umbrellaCanopy',
      { width: 1.8, height: 0.12, depth: 1.8 },
      accentMaterial,
      [0, height, 0]
    );
    return group;
...
function createVisualDetailPrimitive(
  ...
  if (definition.kind === 'wall-art-triptych-detail') {
    [-0.72, 0, 0.72].forEach((x, index) => {
      addBox(
        group,
        `wallArtPanel${index}`,
        { width: 0.5, height: 0.7, depth: 0.04 },
        accentMaterial,
        [x, 1.35, 0]
      );
    });
  ...
  if (definition.kind === 'console-plant-detail') {
    addTinyPlant(group, 'consolePlant', 0, 0.92, 0);
    return group;
  }
  ...
  if (definition.kind === 'table-bowl-detail') {
    addBox(
      group,
      'coffeeTableBowl',
      { width: 0.38, height: 0.12, depth: 0.28 },
      baseMaterial,
      [0, 0.55, 0]
    );
    addBox(
      group,
      'coffeeTableBowlFruit',
  ...
  if (definition.kind === 'spice-rack-detail') {
    addBox(
      group,
      'spiceRackShelf',
      { width: 0.08, height: 0.12, depth: 1.15 },
      baseMaterial,
      [0, 1.35, 0]
    );
    [-0.36, 0, 0.36].forEach((z, index) => {
      addBox(
        group,
        `spiceJar${index}`,
        { width: 0.12, height: 0.28, depth: 0.12 },
        accentMaterial,
        [0, 1.55, z]
      );
    });
  ...
  if (definition.kind === 'string-lights-detail') {
    addBox(
      group,
      'stringLightCable',
      { width: 5.2, height: 0.035, depth: 0.035 },
      baseMaterial,
      [0, 2.55, 0]
    );
  ...
  if (definition.kind === 'watering-can-detail') {
    addBox(
      group,
      'wateringCanBody',
      { width: 0.34, height: 0.22, depth: 0.24 },
      baseMaterial,
      [0, 0.28, 0]
    );
    addBox(
      group,
      'wateringCanSpout',
      { width: 0.34, height: 0.06, depth: 0.06 },
      accentMaterial,
      [0.28, 0.34, 0]
    );
    return group;
