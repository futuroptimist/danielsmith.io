...
function initializeImmersiveScene(
  ...
  const ensureKeyBindingApi = () => {
    ensurePortfolioInputNamespace().keyBindings = {
      getBindings() {
  ...
  function disposeDebugPerformanceRegistration() {
    ...
    removePortfolioSection('debugPerformance');
  }
  ...
  function disposeImmersiveResources() {
    ...
    delete ensurePortfolioInputNamespace().keyBindings;
    removePortfolioSection('avatar');
    removePortfolioSection('poi');
    removePortfolioSection('graphics');
    removePortfolioSection('githubMetrics');
    removePortfolioSection('audio');
    removePortfolioSection('narration');
    removePortfolioSection('debugColliders');
    removePortfolioSection('debugSolids');
    removePortfolioSection('debugCoordinates');
    disposeDebugPerformanceRegistration();
