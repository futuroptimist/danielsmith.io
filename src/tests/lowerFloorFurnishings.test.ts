...
describe('lower floor furnishings foundation', () => {
  it('renders the default lower-floor furnishing clusters', () => {
  ...
  it('keeps the kitchen kitchenette and dining furnishings within kitchen bounds', () => {
    ...
    kitchenIds.forEach((id) => {
      ...
      expect(collider?.roomId).toBe('kitchen');
