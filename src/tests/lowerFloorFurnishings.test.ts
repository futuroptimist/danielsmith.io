...
describe('lower floor furnishings foundation', () => {
  ...
  it('adds the studio sleeping nook with requested AABBs and a non-blocking rug', () => {
  ...
  it('keeps sleeping nook solids clear of studio doorway buffers and POI blockers', () => {
