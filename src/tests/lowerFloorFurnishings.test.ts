...
describe('upper floor furnishings foundation', () => {
  ...
  it('adds requested upstairs decor solids and visual-only details', () => {
    const { colliders, group } = createUpperFloorFurnishings();
    const expectedDecorBounds: Record<string, RectCollider> = {
  ...
  it('represents upstairs greenery variety across furnishing metadata', () => {
    const greeneryKinds = new Set([
      'large-potted-plant',
      'monstera-plant',
      'snake-plant',
      'fern-plant',
