...
{{- fail "githubMetricsCache.repos must include at most 50 repositories" -}}
{{- end -}}
...
{{- end -}}
{{- if or (not (regexMatch "^[A-Za-z0-9_.-]{1,100}$" $repo.owner)) (not (regexMatch "^[A-Za-z0-9_.-]{1,100}$" $repo.repo)) -}}
{{- fail (printf "githubMetricsCache.repos[%d] owner and repo must use bounded GitHub name characters" $index) -}}
{{- end -}}
{{- end -}}
{{- end -}}
{{- end -}}
